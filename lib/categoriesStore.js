...
const { init, persist } = makePersistent({ r2Key: 'data/categories.json', readLocal: readAll, writeLocal: writeAll });
...
module.exports = { getAllSorted, getVisible, getById, create, update, remove, slugify, init };
